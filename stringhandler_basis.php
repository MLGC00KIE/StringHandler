	 ...
	 <body>
		...
		<div class="wrapper">
			<form method="GET" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<fieldset>
				 <legend>Mitchell Tuinstra GD1A</legend>
			...
			?><ul>
                    ...
                    <li>Zoeken naar @. Er zit een spatie op positie: <?php echo strpos($string3,"@"); ?></li>
                    <li>Zoeken naar "." . Er zit een spatie op positie: <?php echo strpos($string3,"."); ?></li>
                    <li>Zoek naar substring <b>"PHP"</b> vervang dit door <b>"NodeJS"</b> <?php echo str_replace("PHP","NODEJS",$string3); ?></li>
